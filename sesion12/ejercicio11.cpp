/*
 * Eliminar un caracter en todas las ocurrencias de un vector del tipo SecuenciaCaracteres
 */
 ...
 *
 * Created on 17 de noviembre de 2016, 14:
 */
...
int main(){
	...
	cout << "\nIntroduzca un carácter a borrar: ";
	cin >> a_borrar;
	
	texto.EliminaOcurrencias(a_borrar);
